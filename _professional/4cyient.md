...
<br>
**Project Details**:
The goal of this project was to perform the high cycle fatigue (HCF) structural analysis on integrated bladed rotors stages 5–8 to assess the life at the leading edge, trailing edge, trench, and balance cut locations as per the criteria mentioned in the engineering statement of work (ESW).
